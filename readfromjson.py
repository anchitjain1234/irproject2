...
for i in range(len(gdata)):
    ...
    gtitsnippet.append(gdata[i]["docid"]+"    :"+gdata[i]["title"].encode('utf8')+" "+gdata[i]["desc"].encode('utf8')+"\n\n\n")    

for i in range(len(ydata)):
    ylink.append(ydata[i]["link"])
    ytitsnippet.append(ydata[i]["docid"]+"    :"+ydata[i]["title"].encode('utf8')+" "+ydata[i]["desc"].encode('utf8')+"\n\n\n")
